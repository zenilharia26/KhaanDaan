...
$(document).ready(function() {
    ...
    showNotification: function(e, a) {
        type = ["", "info", "danger", "success", "warning", "primary"], color = Math.floor(5 * Math.random() + 1), $.notify({
            icon: "add_alert",
    ...
    startAnimationForLineChart: function(e) {
        e.on("draw", function(e) {
            "line" !== e.type && "area" !== e.type || !window.matchMedia("(min-width: 900px)").matches ? "point" === e.type && (seq++, e.element.animate({
                opacity: {
                    begin: seq * delays,
                    dur: durations,
                    from: 0,
    ...
    startAnimationForBarChart: function(e) {
        e.on("draw", function(e) {
            "bar" === e.type && window.matchMedia("(min-width: 900px)").matches && (seq2++, e.element.animate({
                opacity: {
                    begin: seq2 * delays2,
                    dur: durations2,
                    from: 0,
